...
public class GuiCustomMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GL11.glEnable(3042);
        FontLoaders.GoogleSans20.drawString("Distance made by Laba Team", Client.FontLoaders.Chinese20.getStringWidth("\u00a9") + 5.5f, sr.getScaledHeight() - 5.5f - FontLoaders.GoogleSans20.getHeight() + 1, new Color(255, 255, 255, 180).getRGB());
