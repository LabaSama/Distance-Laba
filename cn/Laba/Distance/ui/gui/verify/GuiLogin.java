package cn.Laba.Distance.ui.gui.verify;
...
import cn.Laba.Distance.ui.gui.GuiWelcome;
...
import cn.Laba.Distance.util.misc.ObfuscatedUtils;
import cn.Laba.Distance.util.render.Blur;
import cn.Laba.Distance.util.render.Colors;
...
public class GuiLogin extends GuiScreen {
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		FontLoaders.GoogleSans16.drawString(Client.name + " made by \u00a7oLaba\u00a7r (Laba Team)", width -
						FontLoaders.GoogleSans16.getStringWidth(Client.name+" made by \u00a7oLaba\u00a7r (Laba Team)") - 1,
	...
	public void initGui() {
		...
		super.initGui();
		this.loginButton = new UIFlatButton(1, 25, var2 + 50, (((width / 3) - 50) / 2) - 2, 20, "µÇÂ¼", Client.getBlueColor());
		this.freeButton = new UIFlatButton(3, 29 + (((width / 3) - 50) / 2) - 2, var2 + 50, (((width / 3) - 50) / 2) - 2, 20, "ÍË³ö", Colors.GREY.c);
