...
import cn.Laba.Distance.ui.gui.mainmenu.animation.AnimatedButton;
...
public class GuiMainMenu extends GuiScreen {
	...
	public void initGui() {
		...
		animatedButtons.add(new AnimatedButton(FontLoader.msFont24, "单人游戏", "C", Math.max(width / 13f,80), (height / 2f) - 40, () ->
				mc.displayGuiScreen(new GuiSelectWorld(new GuiMainMenu()))));
		animatedButtons.add(new AnimatedButton(FontLoader.msFont24, "多人游戏", "B", Math.max(width / 13f,80), (height / 2f) - 20, () ->
				mc.displayGuiScreen(new GuiMultiplayer(new GuiMainMenu()))));
		animatedButtons.add(new AnimatedButton(FontLoader.msFont24, "账号管理器", "A", Math.max(width / 13f,80), (height / 2f), () ->
				mc.displayGuiScreen(new GuiAltManager())));
		animatedButtons.add(new AnimatedButton(FontLoader.msFont24, "选项", "G", Math.max(width / 13f,80), (height / 2f) + 20, () ->
				mc.displayGuiScreen(new GuiOptions(new GuiMainMenu(), mc.gameSettings))));
		animatedButtons.add(new AnimatedButton(FontLoader.msFont24, "退出", "D", Math.max(width / 13f,80), (height / 2f) + 40, () ->
				hovered = true));
