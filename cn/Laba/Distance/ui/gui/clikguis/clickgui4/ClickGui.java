package cn.Laba.Distance.ui.gui.clikguis.clickgui4;
...
public class ClickGui extends GuiScreen implements GuiYesNoCallback {
	...
	private final int ClientColors = cn.Laba.Distance.module.modules.render.ClickGui.CustomColor.getValue()? Client.getClientColor() : Client.getBBlueColor();
