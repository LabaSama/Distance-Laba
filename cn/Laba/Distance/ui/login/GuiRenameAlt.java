...
public class GuiRenameAlt extends GuiScreen {
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		Helper.mc.fontRendererObj.drawCenteredString("±à¼­ÕËºÅ", this.width / 2, 10, -1);
		Helper.mc.fontRendererObj.drawCenteredString(this.status, this.width / 2, 20, -1);
		this.nameField.drawTextBox();
		this.pwField.drawTextBox();
		if (this.nameField.getText().isEmpty()) {
			Helper.mc.fontRendererObj.drawStringWithShadow("ÐÂµÄÓÊÏäµØÖ·", this.width / 2 - 96, 66.0f, -7829368);
		}
		if (this.pwField.getText().isEmpty()) {
			Helper.mc.fontRendererObj.drawStringWithShadow("ÐÂµÄÃÜÂë", this.width / 2 - 96, 106.0f, -7829368);
		}
	...
	@Override
	public void initGui() {
		this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 92 + 12, "±à¼­"));
		this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 116 + 12, "·µ»Ø"));
