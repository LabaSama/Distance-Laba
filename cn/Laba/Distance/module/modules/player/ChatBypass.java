...
public class ChatBypass extends Module {
    ...
    public void onPacketReceive(EventPacketReceive e){
        if (e.getPacket() instanceof S02PacketChat) {
            ...
            if (packet.getChatComponent().getUnformattedText().contains("©Y")) {
                packet.setChatComponent(new ChatComponentText(packet.getChatComponent().getUnformattedText().replace("©Y", "")));
            }
        }
    }
