package cn.Laba.Distance.module.modules.render.nametagmodules;

import cn.Laba.Distance.Client;
import cn.Laba.Distance.manager.FriendManager;
import cn.Laba.Distance.module.modules.combat.AntiBot;
import cn.Laba.Distance.module.modules.combat.HypixelAntibot;
import cn.Laba.Distance.module.modules.world.Teams;
                    ...
                    for (ItemStack p_getEnchantmentLevel_1_ : list) {
                        ...
                        if (p_getEnchantmentLevel_1_ != null) {
                            ...
                            if (enchantmentLevel3 > 0) {
                                ...
                                drawEnchantTag("¡ì6¡ìlGod", p_renderItemOverlays_3_ - 2, n13);
                            }
