...
import cn.Laba.Distance.api.events.Misc.EventKey;
import cn.Laba.Distance.api.events.World.EventAttack;
import cn.Laba.Distance.api.events.World.EventTick;
import cn.Laba.Distance.api.events.World.EventWorldChanged;
import cn.Laba.Distance.api.verify.SHWID;
import cn.Laba.Distance.ui.gui.mainmenu.GuiMainMenu;
import cn.Laba.Distance.ui.gui.GuiNeedBlur;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public void drawSplashScreen(int much) {
        ...
        GlStateManager.alphaFunc(516, 0.1F);
        much = much / 10;
        Display.setTitle("Minecraft 1.8.9 | Loading!Distance Client正在加载中 请稍后 " + much + "/6");
        this.updateDisplay();
    }
